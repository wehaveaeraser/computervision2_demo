"""
CNN 모델 학습 스크립트 (원래 데이터 + lwdds 데이터 합치기)
"""
import torch
...
def main():
    parser = argparse.ArgumentParser(description='CNN 모델 학습 (원래 데이터 + lwdds 데이터 합치기)')
    ...
    print(f'   python inference_cnn.py --model_path {args.checkpoint_dir}/best_model.pth --noisy_dir ./test/syn/rainy_vid --clean_dir ./test/syn/clean_vid --visualize')
